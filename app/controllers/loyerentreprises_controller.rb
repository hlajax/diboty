class LoyerentreprisesController < ApplicationController
  ...
  private
    ...
    def loyerentreprise_params
      params.require(:loyerentreprise).permit(:nom_proprietaire, :date_de_naissance_proprietaire, :lieu_de_naissance_proprietaire,:piece_id, :numero_piece, :telephones_proprietaire, :email_proprietaire, :situation_id, :lieu_de_residence_proprietaire, :raison_sociale, :secteur, :fiche, :rccm, :nif, :telephones, :email, :cnamgs, :cnss, :type_id, :construction_id, :province_id, :arrondissement_id, :loyer_mensuel, :loyer_trimestriel, :adresse, :quartier, :autre, :chef_id,:distribue_id, :actu_id, :compte_id)
    end
end
