class DonsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @don.save
        format.html { redirect_to @don, notice: 'Don was successfully created.' }
  ...
  private
    ...
    def don_params
      params.require(:don).permit(:nom, :nom_entreprise, :numero_de_telephone, :email, :adresse, :detail, :date)
    end
end
