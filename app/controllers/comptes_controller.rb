class ComptesController < ApplicationController
  ...
  private
    ...
    def compte_params
      params.require(:compte).permit(:nom, :nom_chef, :telephone, :sex_id, :situation_id, :statut_id, :province_id, :nationalite, :commune, :quartier, :date, :lieu, :cnamgs, :cnss, :one, :arrondissement_id, :chef_id, :nombreepouse, :photo)
    end
end
