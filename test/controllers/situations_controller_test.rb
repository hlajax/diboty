...
class SituationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create situation" do
    assert_difference('Situation.count') do
      post situations_url, params: { situation: { description: @situation.description, nom: @situation.nom, slug: @situation.slug } }
    end
  ...
  test "should update situation" do
    patch situation_url(@situation), params: { situation: { description: @situation.description, nom: @situation.nom, slug: @situation.slug } }
