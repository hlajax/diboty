...
class ActualitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actualite" do
    assert_difference('Actualite.count') do
      post actualites_url, params: { actualite: { lien: @actualite.lien, photo: @actualite.photo, titre: @actualite.titre } }
    end
  ...
  test "should update actualite" do
    patch actualite_url(@actualite), params: { actualite: { lien: @actualite.lien, photo: @actualite.photo, titre: @actualite.titre } }
