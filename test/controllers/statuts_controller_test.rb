...
class StatutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statut" do
    assert_difference('Statut.count') do
      post statuts_url, params: { statut: { description: @statut.description, nom: @statut.nom } }
    end
  ...
  test "should update statut" do
    patch statut_url(@statut), params: { statut: { description: @statut.description, nom: @statut.nom } }
