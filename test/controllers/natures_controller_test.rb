...
class NaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nature" do
    assert_difference('Nature.count') do
      post natures_url, params: { nature: { detail: @nature.detail, nom: @nature.nom, slug: @nature.slug } }
    end
  ...
  test "should update nature" do
    patch nature_url(@nature), params: { nature: { detail: @nature.detail, nom: @nature.nom, slug: @nature.slug } }
