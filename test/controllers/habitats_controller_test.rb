...
class HabitatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habitat" do
    assert_difference('Habitat.count') do
      post habitats_url, params: { habitat: { description: @habitat.description, nom: @habitat.nom } }
    end
  ...
  test "should update habitat" do
    patch habitat_url(@habitat), params: { habitat: { description: @habitat.description, nom: @habitat.nom } }
