...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { description: @piece.description, nom: @piece.nom, slug: @piece.slug } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { description: @piece.description, nom: @piece.nom, slug: @piece.slug } }
