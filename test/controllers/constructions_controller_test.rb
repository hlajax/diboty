...
class ConstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create construction" do
    assert_difference('Construction.count') do
      post constructions_url, params: { construction: { description: @construction.description, nom: @construction.nom, slug: @construction.slug } }
    end
  ...
  test "should update construction" do
    patch construction_url(@construction), params: { construction: { description: @construction.description, nom: @construction.nom, slug: @construction.slug } }
