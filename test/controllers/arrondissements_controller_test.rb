...
class ArrondissementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arrondissement" do
    assert_difference('Arrondissement.count') do
      post arrondissements_url, params: { arrondissement: { description: @arrondissement.description, nom: @arrondissement.nom, slug: @arrondissement.slug } }
    end
  ...
  test "should update arrondissement" do
    patch arrondissement_url(@arrondissement), params: { arrondissement: { description: @arrondissement.description, nom: @arrondissement.nom, slug: @arrondissement.slug } }
