...
class VillesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ville" do
    assert_difference('Ville.count') do
      post villes_url, params: { ville: { description: @ville.description, nom: @ville.nom, slug: @ville.slug } }
    end
  ...
  test "should update ville" do
    patch ville_url(@ville), params: { ville: { description: @ville.description, nom: @ville.nom, slug: @ville.slug } }
