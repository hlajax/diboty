...
class SexesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sex" do
    assert_difference('Sex.count') do
      post sexes_url, params: { sex: { description: @sex.description, nom: @sex.nom, slug: @sex.slug } }
    end
  ...
  test "should update sex" do
    patch sex_url(@sex), params: { sex: { description: @sex.description, nom: @sex.nom, slug: @sex.slug } }
